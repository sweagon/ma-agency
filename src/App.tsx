...
import { HeroWithSkeleton } from './components/HeroWithSkeleton';

// Lazy load heavy components
const TextScramble = lazy(() => import("./components/TextScramble").then(module => ({ default: module.TextScramble })));
const LinkPreview = lazy(() => import("./components/LinkPreview").then(module => ({ default: module.LinkPreview })));
const DotGlobeHero = lazy(() => import("./components/globe-hero").then(module => ({ default: module.DotGlobeHero })));
const CelestialOrrery = lazy(() => import("./components/celestial-orrery").then(module => ({ default: module.Component })));
const MorphingText = lazy(() => import("./components/liquid-text").then(module => ({ default: module.MorphingText })));
const CircularRevealHeading = lazy(() => import("./components/circular-reveal-heading").then(module => ({ default: module.CircularRevealHeading })));
...
// Loading fallback for other sections
        ...
        <div className="min-h-screen bg-[#111111] text-white selection:bg-red-600 selection:text-white font-sans overflow-x-hidden">
            ...
            <nav className="fixed top-0 left-0 right-0 z-50 px-6 py-6 flex items-center justify-between mix-blend-difference">
                ...
                <div className="hidden md:flex items-center gap-8 text-sm font-medium uppercase tracking-widest">
                    ...
                    <Suspense fallback={<span>Projects</span>}>
            ...
            <HeroWithSkeleton>
                <section className="relative min-h-screen">
                    ...
                    <div className="absolute inset-0 z-0">
                        <Suspense fallback={<div className="w-full h-full bg-gradient-to-b from-[#111111] to-red-600/5" />}>
                            <CelestialOrrery />
                        </Suspense>
                    </div>
                    ...
                    <Suspense fallback={<ComponentLoader />}>
                        <DotGlobeHero
                            rotationSpeed={0.004}
                            className="transform-gpu will-change-transform bg-gradient-to-tr from-[#111111] via-[#111111]/95 to-red-600/10 relative overflow-hidden min-h-screen"
                        >
                            {/* Background effects */}
                                ...
                                >
                                    ...
                                    <div className="space-y-6">
                                        ...
                                        >
                                            ...
                                            <span className="block relative min-h-[1em] items-center justify-center">
                                                <Suspense fallback={<span className="text-white">Innovate</span>}>
                                    ...
                                    >
                                        <p className="text-xl md:text-2xl text-white/70 leading-relaxed font-medium">
                                            ...
                                            <Suspense fallback={<span>digital experiences</span>}>
                                        ...
                                        <p className="text-lg text-white/50 leading-relaxed">
                                            We build <Suspense fallback={<span>global legacies</span>}>
                                                <TextScramble text="global legacies" className="text-white font-semibold" />
                                            </Suspense> from our studio in London.
                                        </p>
                                    </motion.div>
                                </motion.div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16">
                    ...
                    >
                        <div className="relative aspect-[4/3] overflow-hidden bg-zinc-900 mb-6 rounded-lg">
                            <OptimizedImage
                                src="/1.webp"
                                alt="Next Wave brand identity and digital platform project by MA Agency"
                    ...
                    >
                        <div className="relative aspect-[4/3] overflow-hidden bg-zinc-900 mb-6 rounded-lg">
                            <OptimizedImage
                                src="/2.webp"
                                alt="island - Go Cappadocia e-commerce experience design"
                                className="object-cover w-full h-full transition-transform duration-700 group-hover:scale-105"
                                priority={false}
                            />
                            <div className="absolute inset-0 bg-black/20 group-hover:bg-transparent transition-colors duration-500" />
                    ...
                    >
                        <div className="relative aspect-[4/3] overflow-hidden bg-zinc-900 mb-6 rounded-lg">
                            <OptimizedImage
                                src="/4.webp"
                                alt="MoonTrue web3 application design project"
                                className="object-cover w-full h-full transition-transform duration-700 group-hover:scale-105"
                                priority={false}
                            />
                            <div className="absolute inset-0 bg-black/20 group-hover:bg-transparent transition-colors duration-500" />
                    ...
                    >
                        <div className="relative aspect-[4/3] overflow-hidden bg-zinc-900 mb-6 rounded-lg">
                            <OptimizedImage
                                src="/3.webp"
                                alt="Let's Renoria global marketing campaign by MA Agency"
                                className="object-cover w-full h-full transition-transform duration-700 group-hover:scale-105"
                                priority={false}
                            />
                            <div className="absolute inset-0 bg-black/20 group-hover:bg-transparent transition-colors duration-500" />
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        ...
                        >
                            <div className="space-y-4">
                                ...
                                >
                                    We deliver{' '}
                                    <Suspense fallback={<span>exceptional</span>}>
                                        <TextScramble
                                            text="exceptional"
                            ...
                            <div className="space-y-6">
                                {[
                                    { title: "Data-Driven Strategy", desc: "Roadmaps built on insights, not assumptions", icon: "📊" },
                                    { title: "Creative Excellence", desc: "Design that captivates and converts", icon: "🎨" },
                                    { title: "Growth Engineering", desc: "Scalable systems for sustainable success", icon: "📈" },
                                    { title: "Future-Ready Innovation", desc: "Staying ahead of tomorrow's trends", icon: "⚡" }
                                ].map((service, index) => (
                                    <motion.div
                                        key={index}
                                        initial={{ opacity: 0, y: 20 }}
                            ...
                            >
                                ...
                                <p className="mt-4 text-sm text-gray-400">
                                    <Suspense fallback={<span>✨ No long-term contracts</span>}>
                                        <MorphingText
            ...
            <section id="contact" className="py-32 px-6 bg-zinc-950">
                <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16">
                    <div>
                        ...
                        <div className="space-y-4 text-sm uppercase tracking-widest text-gray-300">
                            <p className="text-white/80 hover:text-white transition-colors">ma.webagency@outlook.com</p>
                            <p className="text-white/80 hover:text-white transition-colors">+44 7311 124096</p>
                            <p className="text-white/80 hover:text-white transition-colors">London, UK</p>
                        </div>
                    </div>
...
function ContactForm() {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            if (response.ok) {
                showSuccessToast("Message Sent! 🎉", "Thank you for reaching out. We'll get back to you within 24 hours.");
                form.reset();
                setStatus("success");
                setTimeout(() => setStatus("idle"), 3000);
            } else {
                const errData = await response.json();
                showErrorToast("Something went wrong", errData.error || 'Failed to send message. Please try again.');
                setStatus("idle");
            }
        } catch (error) {
            console.error('Error:', error);
            showErrorToast("Connection Error", "Unable to send your message. Please check your internet connection and try again.");
            setStatus("idle");
        }
    };
        ...
        <form onSubmit={handleSubmit} className="space-y-12">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                <div className="relative group">
                    <input type="text" id="name" required className="w-full bg-transparent border-b border-white/20 pb-4 text-xl text-white focus:outline-none focus:border-red-600 transition-colors peer placeholder-transparent" placeholder="John Doe" />
                    <label htmlFor="name" className="absolute left-0 -top-6 text-sm font-medium text-gray-300 transition-all peer-placeholder-shown:text-xl peer-placeholder-shown:top-0 peer-focus:-top-6 peer-focus:text-sm peer-focus:text-red-600">Name</label>
                </div>
                <div className="relative group">
                    <input type="email" id="email" required className="w-full bg-transparent border-b border-white/20 pb-4 text-xl text-white focus:outline-none focus:border-red-600 transition-colors peer placeholder-transparent" placeholder="john@example.com" />
                    <label htmlFor="email" className="absolute left-0 -top-6 text-sm font-medium text-gray-300 transition-all peer-placeholder-shown:text-xl peer-placeholder-shown:top-0 peer-focus:-top-6 peer-focus:text-sm peer-focus:text-red-600">Email</label>
                </div>
            </div>

            <div className="relative group">
                <input type="text" id="company" className="w-full bg-transparent border-b border-white/20 pb-4 text-xl text-white focus:outline-none focus:border-red-600 transition-colors peer placeholder-transparent" placeholder="Your Company" />
                <label htmlFor="company" className="absolute left-0 -top-6 text-sm font-medium text-gray-300 transition-all peer-placeholder-shown:text-xl peer-placeholder-shown:top-0 peer-focus:-top-6 peer-focus:text-sm peer-focus:text-red-600">Company (Optional)</label>
            </div>

            <div className="relative group">
                <textarea id="message" required rows={1} className="w-full bg-transparent border-b border-white/20 pb-4 text-xl text-white focus:outline-none focus:border-red-600 transition-colors peer placeholder-transparent resize-none overflow-hidden" placeholder="Tell us about your project..." onInput={(e) => { const target = e.target as HTMLTextAreaElement; target.style.height = 'auto'; target.style.height = target.scrollHeight + 'px'; }} />
                <label htmlFor="message" className="absolute left-0 -top-6 text-sm font-medium text-gray-300 transition-all peer-placeholder-shown:text-xl peer-placeholder-shown:top-0 peer-focus:-top-6 peer-focus:text-sm peer-focus:text-red-600">Project Details</label>
            </div>

            <button type="submit" disabled={status === "submitting" || status === "success"} className="w-full md:w-auto px-12 py-6 bg-red-600 text-white font-medium uppercase tracking-widest rounded-full hover:bg-red-700 transition-all hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100 flex items-center justify-center gap-4">
                {status === "submitting" ? <span className="animate-pulse">Sending...</span> : status === "success" ? <span>Message Sent!</span> : <>Send Message <ArrowRight className="w-5 h-5" /></>}
            </button>
        </form>
    );
}